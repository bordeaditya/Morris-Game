/*
 * Author 	: Aditya Borde
 * File 	: MiniMaxGameImproved.java
 * Function : MiniMax Mid game and End game using Improved Static Estimation Function 
 */
...
public class MiniMaxGameImproved {
	...
	public static void main(String[] args) throws IOException {
		...
		// MiniMax Algorithm - Mid game End game Phase FOR "WHITE"
	...
	public static Estimations MiniMax(MorrisBoard mB, int depth, boolean isWhite) 
	{
		...
		{
			// Static Estimation for Mid Game - End Game Improved.
			estFinal.setEstimate(MorrisGame.GetStaticEstimationImprovedMidgameEndgame(mB));
			estFinal.setPositionsEvaluated(estFinal.getPositionsEvaluated() + 1);
			return estFinal;
		}
